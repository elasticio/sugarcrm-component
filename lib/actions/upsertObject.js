...
exports.getMetaModel = async function getMetaModel(cfg) {
  ...
  const moduleMetaData = await instance.getModuleMetaData(cfg.module);
  ...
  modelMetadata.in.properties = {
    ...modelMetadata.in.properties,
    ...additionalInMetaFields[cfg.module],
  };
  modelMetadata.out = outSchema;
